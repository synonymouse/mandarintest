<?php
/**
 * Golden Mandarin functions and definitions.
 *
...
function index_setup() {
	 ...
	 * If you're building a theme based on Golden Mandarin, use a find and replace
	...
	register_nav_menus( array( // Регистрируем меню футера и хедера
		'top' => 'Меню общее'
	) );
	register_nav_menus( array( // Регистрируем меню услуг
		'service' => 'Меню услуг'
	) );
...
function index_scripts() {
	...
	wp_enqueue_script( 'index-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'index-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
